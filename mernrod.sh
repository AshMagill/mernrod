...
sudo -u "$name" code --install-extension ~/mernrod/vscode-installer/CachedExtensionVSIXs/esbenp.prettier-vscode.vsix --enable-proposed-api main/mernrod/vscode-installer/CachedExtensionVSIXs/esbenp.prettier-vscode &
...
cp -f ~/mernrod/vscode-installer/settings.json ~/.config/Code/User &
