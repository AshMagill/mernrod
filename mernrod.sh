...
sudo -u "$name" dialog --title "MERNROD Installation" --infobox "Installing VSCode extensions..." 5 70
...
sudo -u "$name" cp -f ./vscode-installer/settings.json ~/.config/Code/User &
