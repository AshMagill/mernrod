...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/AshMagill/voidrice-react.git"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Luke's Auto-Rice Bootstrapping Script with a modified config for React Web Developers!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Luke" 10 60
